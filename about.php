...
?>
    ...
    <div data-page="about" class="container-fluid">
        <div id="backgroundAbout">
            <img class="img-responsive" width="1920" height="778" src="img/bg-about.jpg">
        </div>
        <div class="containerAbout container">
            <h1>GL Organisation</h1>
            <div class="accroche">
                <p>Canvassing and identification of foreign producers for licencing contracts, sale or co-production, and tours of the show. </p>
            </div>
            <div class="row" id="content_about">
                <div class="divContent" id="divRougeAbout" class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
